...
function resolveOptions(options, root) {
  ...
  if (resolved.globs) {
    resolved.globs = _utils.toArray.call(void 0, resolved.globs).map((glob) => _utils.slash.call(void 0, resolveGlobsExclude(root, glob)).replace(/\[/g, "\\[").replace(/\]/g, "\\]"));
    ...
    resolved.globs = resolved.resolvedDirs.map(
      (i) => (resolved.deep ? _utils.slash.call(void 0, _path.join.call(void 0, i, `**/*.${extsGlob}`)) : _utils.slash.call(void 0, _path.join.call(void 0, i, `*.${extsGlob}`))).replace(/\[/g, "\\[").replace(/\]/g, "\\]")
    );
